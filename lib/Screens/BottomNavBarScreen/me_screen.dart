...
class MeScreen extends StatelessWidget {
        ...
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              // If user is not authenticated OR API fails → show Login/Create Account
              return _buildGuestView(context, pad);
            ...
            final firstName = userData['customer']['firstName'] ?? 'User';
            final lastName = userData['customer']['lastName'] ?? '';
  ...
  Widget _buildGuestView(BuildContext context, double pad) {
    return ListView(
      padding: EdgeInsets.symmetric(horizontal: pad),
      children: [
        const SizedBox(height: 10),
        ...
        // Show Login & Create Account only if not logged in
        Row(
          children: [
            Expanded(
              child: SizedBox(
