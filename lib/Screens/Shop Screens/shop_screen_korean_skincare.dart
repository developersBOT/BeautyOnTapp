// lib/Screens/shop_screen_korean_skincare.dart
...
class ShopScreenKoreanSkincare extends StatefulWidget {
  const ShopScreenKoreanSkincare({super.key});

  @override
  State<ShopScreenKoreanSkincare> createState() => _ShopScreenKoreanSkincareState();
}

class _ShopScreenKoreanSkincareState extends State<ShopScreenKoreanSkincare> {
      ...
      body: CustomScrollView(
        slivers: [
              ...
              child: Row(
                children: [
                  ...
                  const Icon(CupertinoIcons.person_crop_circle_badge_checkmark,
                      color: _ShopColors.kBeautyPink, size: 20),
                ],
              ),
            ),
          ),
          ...
          SliverList.separated(
            itemCount: koreanSkinCareEntries.length,
            separatorBuilder: (_, __) => const Divider(
              height: 1,
              color: Colors.grey,
            ),
            itemBuilder: (context, i) {
              final sub = koreanSkinCareEntries[i];
              return ListTile(
                title: Text(
                  sub,
                ...
                onTap: () {
                  // Slugify sub-item for API URL, prefixed with 'korean-skincare-'
                  final slug = sub
                      .toLowerCase()
                      .replaceAll(' ', '-')
