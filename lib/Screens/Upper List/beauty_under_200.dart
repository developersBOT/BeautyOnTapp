...
class BeautyUnder200Screen extends StatefulWidget {
  const BeautyUnder200Screen({super.key});

  @override
  State<BeautyUnder200Screen> createState() => _BeautyUnder200ScreenState();
}

class _BeautyUnder200ScreenState extends State<BeautyUnder200Screen> {
  bool inStock = false;
